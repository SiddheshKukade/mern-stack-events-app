  ...
  return (
    ...
    {next?   <Navigate to="/home" replace/> : null} 
      ...
      <div className={styles.container}>
        <h1 className={styles.title}>Signup Form (with password hashing and encryption provided on the backend) </h1>
        <input type="text" value={username} placeholder="Username" onChange={(e)=>setUsername(e.target.value)} /> <br />
        <input type="emmail" value={email} placeholder="Email" onChange={(e)=>setEmail(e.target.value)} /> <br />
